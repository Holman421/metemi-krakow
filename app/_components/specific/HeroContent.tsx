...
export default function HeroContent() {
  return (
    <div className="flex flex-col z-[3] xl:w-[55%]">
      <div className="ml-[clamp(2.5rem,calc(1.102rem+5.592vw),7.813rem)] flex flex-col gap-35 md:gap-16 xl:text-start text-center -translate-x-[clamp(1.25rem,calc(0.921rem+1.316vw),2.5rem)]">
